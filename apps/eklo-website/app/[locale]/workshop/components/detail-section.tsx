  ...
  return (
    ...
    >
      <p className={styles.paragraph}>
        ...
        CV/LM/Phỏng vấn) để có thể thể hiện được tốt nhất khả năng của bản thân,
        đồng thời lại tạo ra sự khác biệt riêng.
        <br />
        ...
        <br />
        Thông qua việc chia sẻ và trao đổi trong một nhóm nhỏ, dưới sự hướng dẫn
        của EKLO, bạn sẽ tìm thấy cho mình những câu trả lời có giá trị, định
        hướng cho bạn trong quá trình tìm việc sau này. Mô hình nhóm nhỏ của
        Workshop cũng giúp bạn nâng cao kỹ năng giao tiếp, lắng nghe và giải
        quyết vấn đề, cũng như là cơ hội để bạn làm quen với những bạn trẻ có
        định hướng và cá tính khác.
      </p>
